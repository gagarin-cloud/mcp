...
export const TOOLS_SNAPSHOT: Readonly<Record<string, SnapshotRow>> = {
  ...
  alerts: ['Show project alerts', true, false, true, false],
  alerts_off: ['Turn off project alerts', false, false, true, false],
  ...
  memory_briefing: ['Read project briefing', true, false, true, false],
  memory_get: ['Read memories in full', true, false, true, false],
  memory_link: ['Link memories', false, false, true, false],
  memory_related: ['Follow memory links', true, false, true, false],
  memory_search: ['Search project memory', true, false, true, false],
  memory_unlink: ['Unlink memories', false, false, true, false],
  ...
  set_alerts: ['Set project alerts', false, false, true, false],
  ...
  test_alerts: ['Send a test alert', false, false, false, false],
